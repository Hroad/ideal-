...
! function (t, i) {
    ...
    function t(t) {
        return !1 !== w && ("standard" === w ? t : w + t.charAt(0).toUpperCase() + t.substr(1))
    }
    ...
    function h(t) {
        ...
        if (!/(SELECT|INPUT|TEXTAREA)/i.test(i.tagName)) {
            ...
            e.initEvent("click", !0, !1), e._constructed = !0, i.dispatchEvent(e)
        }
    }
    ...
    function d(t, i, e, s, o, n) {
        var r = t - i,
            ...
            u = p ? 4 : 15,
            m = t + h / a * (r < 0 ? -1 : 1);
        return p && l && (m = Math.round(m / l) * l), m < s ? (m = o ? s - o / u * h : s, d = c) : m > 0 && (m = o ? o / u * h : 0, d = c), {
    ...
    function m(t, i) {
        this.wrapper = i.el, this.wrapperStyle = this.wrapper.style, this.indicator = this.wrapper.children[0], this.indicatorStyle = this.indicator.style, this.scroller = t, this.direction = i.direction, i.fade ? (this.visible = 0, this.wrapperStyle.opacity = "0") : this.visible = 1
    }
    ...
    var v = function () {
        ...
        D = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.oRequestAnimationFrame || function (t) {
            return window.setTimeout(t, (t.interval || 100 / 60) / 2)
        },
        k = window.cancelAnimationFrame || window.webkitCancelAnimationFrame || window.mozCancelAnimationFrame || window.oCancelAnimationFrame || function (t) {
            window.clearTimeout(t)
        };
    return m.prototype.refresh = function () {
            this.transitionTime(), this._calculate(), this.updatePosition()
        }, m.prototype.fade = function (t, i) {
            var e = this;
            if (!i || this.visible) {
                var s = t ? 250 : 500;
                t = t ? "1" : "0", this.wrapperStyle[Y.transitionDuration] = s + "ms", clearTimeout(this.fadeTimeout), this.fadeTimeout = setTimeout(function () {
            ...
            if ("vertical" === this.direction) {
                ...
                this.indicatorWidth = Math.max(Math.round(i * i / (this.scroller.scrollerHeight || i || 1)), 8), this.indicatorStyle.width = this.indicatorWidth + "px", this.maxPosX = i - this.indicatorWidth, this.sizeRatioX = this.maxPosX / this.scroller.maxScrollX
            }
        },
        function (t) {
        ...
        function (t) {
            t.prototype._start = function (t) {
                var i = _[t.type];
                if ((i === M || 0 === t.button) && !(!this.enabled || this.destroyed || this.initiated && this.initiated !== i)) {
                ...
                if (this.enabled && !this.destroyed && _[t.type] === this.initiated) {
                    ...
                    if (!(r - this.endTime > this.options.momentumLimitTime && n < this.options.momentumLimitDistance && o < this.options.momentumLimitDistance)) {
                        ...
                        var l = document.documentElement.scrollLeft || window.pageXOffset || document.body.scrollLeft,
                            ...
                            d = this.pointX - l,
                            u = this.pointY - p;
                        (d > document.documentElement.clientWidth - this.options.momentumLimitDistance || d < this.options.momentumLimitDistance || u < this.options.momentumLimitDistance || u > document.documentElement.clientHeight - this.options.momentumLimitDistance) && this._end(t)
                    }
                }
            }, t.prototype._end = function (t) {
                if (this.enabled && !this.destroyed && _[t.type] === this.initiated && (this.initiated = !1, this.options.preventDefault && !n(t.target, this.options.preventDefaultException) && t.preventDefault(), this.trigger("touchEnd", {
                        x: this.x,
                        y: this.y
                    }), !(this.options.pullDownRefresh && this._checkPullDown() || this.resetPosition(this.options.bounceTime, H.bounce)))) {
                    ...
                    if (this.moved) {
                        ...
                        var l = this.endTime - this.startTime,
                            p = Math.abs(i - this.startX),
                            u = Math.abs(e - this.startY);
                        if (this._events.flick && l < this.options.flickLimitTime && p < this.options.flickLimitDistance && u < this.options.flickLimitDistance) this.trigger("flick");
                        else {
                            var m = 0;
                            if (this.options.momentum && l < this.options.momentumLimitTime && (u > this.options.momentumLimitDistance || p > this.options.momentumLimitDistance)) {
                                var f = this.hasHorizontalScroll ? d(this.x, this.startX, l, this.maxScrollX, this.options.bounce ? this.wrapperWidth : 0, this.options) : {
                                        destination: i,
                                        duration: 0
                                    },
                                    g = this.hasVerticalScroll ? d(this.y, this.startY, l, this.maxScrollY, this.options.bounce ? this.wrapperHeight : 0, this.options) : {
                                        destination: e,
                                        duration: 0
                                    };
                                i = f.destination, e = g.destination, m = Math.max(f.duration, g.duration), this.isInTransition = 1
                            ...
                            if (this.options.snap) {
                                ...
                                this.currentPage = y, m = this.options.snapSpeed || Math.max(Math.max(Math.min(Math.abs(i - y.x), 1e3), Math.min(Math.abs(e - y.y), 1e3)), 300), i = y.x, e = y.y, this.directionX = 0, this.directionY = 0, v = H.bounce
                            }
                            if (i !== this.x || e !== this.y) return (i > 0 || i < this.maxScrollX || e > 0 || e < this.maxScrollY) && (v = H.swipeBounce), void this.scrollTo(i, e, m, v);
                        ...
                        if (this.options.wheel) {
                            if (this.target && "wheel-scroll" === this.target.className) {
                                var x = Math.abs(Math.round(e / this.itemHeight)),
                                    w = Math.round((this.pointY + s(this.target).top - this.itemHeight / 2) / this.itemHeight);
                                this.target = this.items[x + w]
                            }
                            this.scrollToElement(this.target, this.options.wheel.adjustTime || 400, !0, !0, H.swipe)
                ...
                function t() {
                    ...
                    i.trigger("scroll", e), i.isInTransition && (i.probeTimer = D(t))
                }
                k(this.probeTimer), this.probeTimer = D(t);
                var i = this
            }, t.prototype._transitionTime = function () {
                var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 0;
                if (this.scrollerStyle[Y.transitionDuration] = t + "ms", this.options.wheel)
                    for (var i = 0; i < this.items.length; i++) this.items[i].style[Y.transitionDuration] = t + "ms";
                if (this.indicators)
                ...
                if (this.scrollerStyle[Y.transitionTimingFunction] = t, this.options.wheel)
                    for (var i = 0; i < this.items.length; i++) this.items[i].style[Y.transitionTimingFunction] = t;
                if (this.indicators)
                    for (var e = 0; e < this.indicators.length; e++) this.indicators[e].transitionTimingFunction(t)
            }, t.prototype._transitionEnd = function (t) {
                t.target === this.scroller && this.isInTransition && (this._transitionTime(), this.pulling || this.resetPosition(this.options.bounceTime, H.bounce) || (this.isInTransition = !1, this.trigger("scrollEnd", {
                    x: this.x,
                    y: this.y
                })))
            }, t.prototype._translate = function (t, i) {
                if (this.options.useTransform ? this.scrollerStyle[Y.transform] = "translate(" + t + "px," + i + "px)" + this.translateZ : (t = Math.round(t), i = Math.round(i), this.scrollerStyle.left = t + "px", this.scrollerStyle.top = i + "px"), this.options.wheel)
                    for (var e = this.options.wheel.rotate, s = void 0 === e ? 25 : e, o = 0; o < this.items.length; o++) {
                        var n = s * (i / this.itemHeight + o);
                        this.items[o].style[Y.transform] = "rotateX(" + n + "deg)"
                    }
                ...
                function o() {
                    var p = c();
                    if (p >= l) return n.isAnimating = !1, n._translate(t, i), void(n.pulling || n.resetPosition(n.options.bounceTime) || n.trigger("scrollEnd", {
                        x: n.x,
                        y: n.y
                    }));
                    var d = s(p = (p - a) / e),
                        u = (t - r) * d + r,
                        m = (i - h) * d + h;
                    n._translate(u, m), n.isAnimating && D(o), 3 === n.options.probeType && n.trigger("scroll", {
                        x: this.x,
                        y: this.y
                    })
                }
                ...
                var e = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : 0,
                    s = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : H.bounce;
                ...
                var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 0,
                    i = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : H.bounce,
                    e = this.x;
                ...
                var t = window.getComputedStyle(this.scroller, null),
                    i = void 0,
                    e = void 0;
                return this.options.useTransform ? (i = +((t = t[Y.transform].split(")")[0].split(", "))[12] || t[4]), e = +(t[13] || t[5])) : (i = +t.left.replace(/[^-\d.]/g, ""), e = +t.top.replace(/[^-\d.]/g, "")), {
                    x: i,
                    y: e
                }
                ...
                this._removeDOMEvents(), this.options.scrollbar && this._removeScrollBars(), this.destroyed = !0, this.trigger("destroy")
            }
        }(g),
        function (t) {
            t.prototype.on = function (t, i) {
                ...
                if (i)
                    for (var e = i.length, s = [].concat(y(i)), o = 0; o < e; o++) {
                        var n = s[o],
                            r = v(n, 2),
                            h = r[0],
                            a = r[1];
        ...
        function (t) {
            t.prototype._initSnap = function () {
                ...
                "string" == typeof s && (s = this.scroller.querySelectorAll(s)), this.on("refresh", function () {
                    if (t.pages = [], t.wrapperWidth && t.wrapperHeight && t.scrollerWidth && t.scrollerHeight) {
                        var e = i.stepX || t.wrapperWidth,
                            ...
                            m = void 0;
                        if (s)
                            for (p = s.length, u = -1; c < p; c++) m = o(s[c]), (0 === c || m.left <= o(s[c - 1]).left) && (d = 0, u++), t.pages[d] || (t.pages[d] = []), r = Math.max(-m.left, t.maxScrollX), h = Math.max(-m.top, t.maxScrollY), a = r - Math.round(m.width / 2), l = h - Math.round(m.height / 2), t.pages[d][u] = {
                                x: r,
                                y: h,
                                width: m.width,
                                height: m.height,
                ...
                var s = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : H.bounce,
                    o = this.options.snap;
        ...
        function (t) {
            t.prototype._initScrollbar = function () {
                ...
                this.options.scrollX && (s = {
                    ...
                    fade: e
                }, this._insertScrollBar(s.el), this.indicators.push(new m(this, s))), this.options.scrollY && (s = {
                    el: u("vertical"),
                    direction: "vertical",
                    fade: e
                }, this._insertScrollBar(s.el), this.indicators.push(new m(this, s))), this.on("refresh", function () {
                    for (var i = 0; i < t.indicators.length; i++) t.indicators[i].refresh()
                }), e && (this.on("scrollEnd", function () {
        ...
        function (t) {
            t.prototype._checkPullDown = function () {
                var t = this.options.pullDownRefresh,
                    ...
                    s = t.stop,
                    o = void 0 === s ? 40 : s;
                return this.y > e && !this.pulling && (this.pulling = !0, this.trigger("pullingDown"), this.scrollTo(this.x, o, this.options.bounceTime, H.bounce)), this.pulling
        ...
        function (t) {
            t.prototype._initPullUp = function () {
                this.options.probeType = 3, this._watchPullUp()
            }, t.prototype._watchPullUp = function () {
                function t() {
                    this.y <= this.maxScrollY + e && (this.trigger("pullingUp"), this.off("scroll", t))
                }
                var i = this.options.pullUpLoad.threshold,
                    e = void 0 === i ? 50 : i;
                this.on("scroll", t)
