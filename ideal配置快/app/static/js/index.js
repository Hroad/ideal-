...
function init() {
    ...
    $(".show_box img").attr("src", "../static/images/index1.png");
...
function swichImg(_index, index) {
    ...
    switch (_index) {
        ...
        case 1:
            $(".show_box").css("background", "#ffffff");
            $(".show_box img").attr("src", "../static/images/intro" + index + ".png");
            break;

        case 2:
            $(".show_box").css("background", "#ffffff");
            $(".show_box img").attr("src", "../static/images/jobs" + index + ".png");
            break;

        case 3:
            $(".show_box").css("background", "#ffffff");
            $(".show_box img").attr("src", "../static/images/token" + index + ".png");
            break;

        case 4:
            $(".show_box").css("background", "#ffffff");
            $(".show_box img").attr("src", "../static/images/process" + index + ".png");
            break;

        case 5:
            $(".show_box").css("background", "#ffffff");
            $(".show_box img").attr("src", "../static/images/about" + index + ".png");
            break;

        case 6:
            $(".show_box").css("background", "#ffffff");
            $(".show_box img").attr("src", "../static/images/welfare" + index + ".png");
            break;

        case 7:
            $(".show_box").css("background", "#e6e6e6");
            $(".show_box img").attr("src", "../static/images/person" + index + ".png");
            break;
