window.onload = function () {
    ...
    function touch() {
        ...
        scroll = new BScroll(pageMain, {
            ...
            HWCompositing: true,
            click: true,
			preventDefault: false      //解决冒泡事件，长按二维码扫描问题
        });
        ...
        $('.conpany-intro')[0].addEventListener('touchstart', function () {
            $(".nav_all").slideUp(280);
        }, false)
        $(".addres")[0].addEventListener('tap', function () {
		   window.location.href = 'https://map.qq.com/m/place/info/uid=8758811217080859080&word=%E5%89%8D%E7%A8%8B%E6%97%A0%E5%BF%A7&type=point'
	   })
