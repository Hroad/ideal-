...
function bszs(bstag){
	...
	for(var i=1;i<=5;i++){
		...
		yshtml += '	<div class="ys-thunb"><img src="images/'+bstag+'ys_thumb'+i+'.png" ></div>'
		yshtml += '	<div class="ys-btn">点击下载</div>'
		yshtml += '	</div>'
	}
...
$('.seach-btn').click(function(){
	$('.ys-boxno').hide()
	$('.ys-boxyes').fadeIn()
	$(".nav li").removeClass("active_bg");
	$(".nav li:eq(0) img").attr('src','images/icon1.png')
})
